...
- One team per player. Invites must be accepted. Only the leader can invite or
...
1. Put `sebbyo-combat-1.0.0.jar` and Fabric API in the **host's** `mods/` folder
...
```bash
./gradlew build          # -> build/libs/sebbyo-combat-1.0.0.jar
