 ...
 *
 * <p>Owo's {@link SliderComponent} extends MC's {@code AbstractSliderButton}, which
 * inherits {@code renderWidget(...)} from {@code AbstractWidget}. Overriding
 * {@code renderWidget} lets us replace the entire visual without calling
 * super, while value handling, MouseButtonEvent/drag, and the {@code onChanged} event
