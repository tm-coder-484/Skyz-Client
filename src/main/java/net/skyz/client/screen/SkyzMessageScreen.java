...
public class SkyzMessageScreen extends BaseUIModelScreen<FlowLayout> {
    ...
    public SkyzMessageScreen(Text message) {
        super(FlowLayout.class, Identifier.of("skyz_client", "loading_message"));
        this.message = message != null ? message : Text.literal("Loading…");
    }
