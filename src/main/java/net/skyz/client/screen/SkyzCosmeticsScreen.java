...
public class SkyzCosmeticsScreen extends BaseUIModelScreen<FlowLayout> {
    ...
    public SkyzCosmeticsScreen(SkyzTitleScreen parent) {
        super(FlowLayout.class, Identifier.of("skyz_client", "cosmetics"));
        this.parent = parent;
    ...
    private void rebuildCard() {
        ...
        // Heading.
        card.child(UIComponents.label(Text.literal("✨  COSMETICS"))
        ...
        if (hasEssential) {
            ...
            ButtonComponent open = UIComponents.button(
                            Text.literal("✨  OPEN ESSENTIAL WARDROBE"),
            ...
            card.child(UIComponents.label(Text.literal("Cosmetics requires the Essential mod"))
            ...
            ButtonComponent copy = UIComponents.button(
                            Text.literal("📋  COPY essential.gg LINK"),
                            b -> {
