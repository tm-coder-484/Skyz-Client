...
public class SkyzFriendsScreen extends BaseUIModelScreen<FlowLayout> {
    ...
    public SkyzFriendsScreen(SkyzTitleScreen parent) {
        super(FlowLayout.class, Identifier.of("skyz_client", "friends"));
        this.parent = parent;
    ...
    private void rebuildCard() {
        ...
        // Heading.
        LabelComponent heading = UIComponents.label(Text.literal("👥  FRIENDS"))
        ...
        if (hasEssential) {
            // Status line.
            card.child(UIComponents.label(Text.literal("✓  Essential v" + essentialVersion + " detected"))
                    .color(Color.ofArgb(0xFF4CFA87))
                    .horizontalTextAlignment(HorizontalAlignment.CENTER)
                    .horizontalSizing(Sizing.fill(100)));
            card.child(UIComponents.label(Text.literal("Click below to open the friends list, party invites, and chat."))
            ...
            ButtonComponent open = UIComponents
                    .button(Text.literal("👥  OPEN ESSENTIAL SOCIAL"),
            ...
            if (!lastError.isEmpty()) {
                ...
                errBox.child(UIComponents.label(Text.literal("⚠ " + lastError))
                        .color(Color.ofArgb(0xFFFFAA88))
                        .horizontalTextAlignment(HorizontalAlignment.CENTER)
                        .horizontalSizing(Sizing.fill(100)));
                errBox.child(UIComponents.label(Text.literal(
            ...
            card.child(UIComponents.label(Text.literal("Friends requires the Essential mod"))
                    .color(Color.ofArgb(0xFFFFBB44))
                    .horizontalTextAlignment(HorizontalAlignment.CENTER)
                    .horizontalSizing(Sizing.fill(100)));
            card.child(UIComponents.label(Text.literal("Essential adds friends, parties, cosmetics, and servers."))
                    .color(Color.ofArgb(SkyzColors.TEXT_MUTED))
                    .horizontalTextAlignment(HorizontalAlignment.CENTER)
                    .horizontalSizing(Sizing.fill(100)));
            ...
            card.child(UIComponents.label(Text.literal("Install from:"))
                    .color(Color.ofArgb(SkyzColors.TEXT_MUTED))
                    .horizontalTextAlignment(HorizontalAlignment.CENTER)
                    .horizontalSizing(Sizing.fill(100)));
            card.child(UIComponents.label(Text.literal("essential.gg"))
                    .color(Color.ofArgb(0xFF4CFA87))
                    .horizontalTextAlignment(HorizontalAlignment.CENTER)
                    .horizontalSizing(Sizing.fill(100)));
            ...
            ButtonComponent copy = UIComponents
                    .button(Text.literal("📋  COPY essential.gg LINK"),
                            b -> {
                                MinecraftClient.getInstance().keyboard.setClipboard("https://essential.gg");
