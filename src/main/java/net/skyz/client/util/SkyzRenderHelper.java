...
public final class SkyzRenderHelper {
     ...
     */
    public static void fillRoundedRect(DrawContext ctx, int x, int y, int w, int h,
     ...
     * produces.
     */
    public static void fillRoundedRectGradient(DrawContext ctx, int x, int y, int w, int h,
     ...
     */
    public static void fillRoundedPanel(DrawContext ctx, int x, int y, int w, int h,
     ...
     */
    public static void fillGlassPanel(DrawContext ctx, int x, int y, int w, int h,
    ...
    public static void fillCircle(DrawContext ctx, int cx, int cy, int radius, int colour) {
        if (radius <= 0) return;
        int r = radius;
    ...
    public static void drawCircleOutline(DrawContext ctx, int cx, int cy, int radius, int colour) {
        if (radius <= 0) return;
        int r = radius;
        int prevDx = -1;
        for (int dy = -r; dy < r; dy++) {
     ...
     */
    public static void fillGlassCircle(DrawContext ctx, int cx, int cy, int radius,
    ...
    public static int textWidthSpaced(net.minecraft.client.font.TextRenderer tr,
    ...
    public static void drawTextSpaced(net.minecraft.client.gui.DrawContext ctx,
        ...
        for (int i = 0; i < text.length(); i++) {
            String c = String.valueOf(text.charAt(i));
            if (shadow) ctx.drawTextWithShadow(tr, c, cursor, y, colour);
            else        ctx.drawText(tr, c, cursor, y, colour, false);
            cursor += tr.getWidth(c) + spacing;
        }
    }

    /** Centered letter-spaced text. */
    public static void drawTextSpacedCentered(net.minecraft.client.gui.DrawContext ctx,
                                              net.minecraft.client.font.TextRenderer tr,
     ...
     */
    public static void drawSoftShadow(DrawContext ctx, int x, int y, int w, int h, int radius) {
     ...
     */
    public static void drawHudPanel(net.minecraft.client.gui.DrawContext ctx,
     ...
     */
    public static void drawGlow(DrawContext ctx, int x, int y, int w, int h, int radius, int colour) {
        int r = Math.max(0, radius);
     ...
     */
    public static void drawSkyzHudPanel(DrawContext ctx, int x, int y, int w, int h, int accent) {
        if (w <= 0 || h <= 0) return;
        int r = h < 8 ? 1 : h < 14 ? 2 : 3;
     ...
     */
    public static void drawSkyzBar(DrawContext ctx, int x, int y, int w, int h,
