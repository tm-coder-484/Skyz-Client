...
public final class SkyzHudState {
    ...
    public static void initDefaults(int W, int H) {
        ...
        // \u2500\u2500 Info \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
        // Defaults sized for typical content. Coordinates wider because
        // large-world Z values (7-digit signed) overflow narrower panels.
        // Biome bumped from 130\u2192160 \u2014 biome names like "Stony Peaks" /
        // "Cherry Grove" / "Bamboo Jungle" need the extra width.
        add("FPS Counter",       "\uD83D\uDCCA", "info",    W/2+5,   2,   80,  18, true);
        add("CPS Counter",       "\uD83D\uDDB1", "info",    W/2-85,  2,   80,  18, false);
        add("Coordinates",       "\uD83D\uDCCC", "info",    4,       4,   180, 18, false);
        add("Biome Display",     "\uD83C\uDF3F", "info",    4,       26,  160, 18, false);
        add("Speed Meter",       "\u26A1",       "info",    W-90,    4,   86,  18, false);
        add("Ping Display",      "\uD83D\uDCE1", "info",    W-90,    26,  86,  18, false);
        add("Reach Display",     "\uD83C\uDFAF", "info",    W/2-45,  H-80,90,  18, false);
        add("Memory Usage",      "\uD83D\uDDA5", "info",    4,       48,  110, 22, false);
        add("Entity Count",      "\uD83D\uDC7E", "info",    4,       72,  110, 18, false);
        ...
        // Durability bars need at least h=20 \u2014 the original h=14 made the
        // icon row and the progress bar overlap so badly the elements
        // looked invisible. Tool and the four armor slots are now stacked
        // bottom-up at h=20 with 22px y-spacing.
        add("Tool Durability",       "\u26CF", "bars", 4, H-22,  120, 20, false);
        add("Helmet Durability",     "\u26D1", "bars", 4, H-44,  120, 20, false);
        add("Chestplate Durability", "\uD83E\uDDF2", "bars", 4, H-66,  120, 20, false);
        add("Leggings Durability",   "\uD83D\uDC56", "bars", 4, H-88,  120, 20, false);
        add("Boots Durability",      "\uD83D\uDC62", "bars", 4, H-110, 120, 20, false);
